...
function PageIndicator({ currentPage = 0 }: { currentPage?: number }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.backgroundContainer}>
        <Image source={b1} style={styles.backgroundImage} resizeMode="cover" />
      </View>
      ...
      <View style={[styles.content, { paddingTop: insets.top + 50 }]}>
        ...
        <View style={styles.phonePreviewContainer}>
          <View style={styles.phoneFrame}>
            <Image source={d1} style={styles.phoneImage} resizeMode="cover" />
          </View>
        </View>
